...
namespace Gopas.XamIntro.Course._4REST.Weather
{
    class WeatherHelper
    {
        ...
        public async static Task<WeatherLocationDTO> GetCurrentConditionsAsync(double latitude, double longitude)
        {
            ...
            {
                var result = Newtonsoft.Json.JsonConvert.DeserializeObject<WeatherLocationDTO>( await response.Content.ReadAsStringAsync());
                return result;
            }
            return null;
        }
